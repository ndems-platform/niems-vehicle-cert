// SVG Icon Components for unified UI
// All icons use stroke style for consistency
...
export function SpinnerIcon({ size = 20, className = '' }: IconProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`icon-spin ${className}`}>
